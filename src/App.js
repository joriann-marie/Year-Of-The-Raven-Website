  ...
  return (
    <div className="App">
      ...
      <header class="masthead">
          <div class="container">
              <div class="masthead-subheading">Raven Studios</div>
              <div class="masthead-heading text-uppercase">Year of The Raven</div>
              <a class="btn btn-primary btn-xl text-uppercase" href="#services">Download</a>
          </div>
      </header>
